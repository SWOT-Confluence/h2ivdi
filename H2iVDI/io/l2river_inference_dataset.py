...
class L2RiverInferenceDataset(L2RiverObservations):
    ...
    def __init__(self, set_def, input_dir: str, output_dir: str, internal_data_correction=True, slope_correction="none",
    ...
    def load_single_reach_set(self, set_def, input_dir: str, output_dir: str, s3_path: str, cycle_attr: str="nt"):
        ...
        self._reach_obs._x[0] = sword._reach_data["dist_out"][0] + reach_length[0]
        ...
        self._reach_obs._x[1] = sword._reach_data["dist_out"][0]
